...
import com.student.services.NoSuchStudentException;
import com.student.services.model.Student;
import com.student.services.model.impl.StudentImpl;
import com.student.services.model.impl.StudentModelImpl;
...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
	 ...
	 */
	@Override
	public Student create(int studentId) {
	...
	@Override
	public Student updateImpl(com.student.services.model.Student student)
	...
	protected Student toUnwrappedModel(Student student) {
		...
		studentImpl.setStd(student.getStd());
	 ...
	 */
	@Override
	public Student fetchByPrimaryKey(int studentId) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.student.services.model.Student")));
